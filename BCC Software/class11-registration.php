...
if ($conn->connect_error) {
	...
	$stmt = $conn->prepare("insert into class11_admission(cand_f_name, cand_l_name, father_name, mother_name, dob, gender, date, village_name, police_station, post_office, pin_code_no, state_name, distt_name, contact_number)
		values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
